// ============================================================
// GET /api/google-calendar?path=/calendars/primary/events&timeMin=...
// Authorization: Bearer <user's Google access_token>
// Proxies the request to https://www.googleapis.com/calendar/v3<path>
// and returns the JSON. Kept as a proxy (like the WHOOP data route)
// for architectural consistency and so the client never needs to
// know Google's base URL.
// ============================================================
